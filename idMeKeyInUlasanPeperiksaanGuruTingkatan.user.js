// ==UserScript==
// @name         Ulasan Guru Tingkatan Peperiksaan IDME
// @namespace    http://tampermonkey.net/
// @version      2024-07-09
// @description  Ulasan Guru Tingkatan IDME
// @author       You
// @match        https://moeissppb.moe.gov.my/pengurusan/peperiksaan/markah/*
...
async function startfill()
{
    ...
    for (let i=0; i<r.length; i++){
        ...
        let total=0;
        [...s].forEach(m =>{
            let mark=parseInt(m.textContent.split(" (")[0]);
            if (m.textContent.split(" (").length==2 && mark) {n++; total+=mark;}
        });
        let gp = total/n;
